/****************************************************************************
 * /arch/cskyv1/src/cskyv1/up_internal.h
 *
...
#ifdef CONFIG_SILAN_TIMER
void sc6138_timerinitialize(void);
#else
#define sc6138_timerinitialize()
#endif
...
#ifdef CONFIG_SILAN_RTC
FAR struct rtc_lowerhalf_s *sc6138_rtc_lowerhalf(void);
#endif
#undef EXTERN
#ifdef __cplusplus
}
