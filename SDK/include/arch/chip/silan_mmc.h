...
#define IO_SEND_OP_COND		  	  5   /* ac   [31:16] RCA 15:flg R1b */
...
/*OCR define*/
#define MMC_LOW_VOL_SUPPORT		 (0x1<<7)
#define OCR_OF_MMC_VOLTAGE          (0x40300000)
#define MMC_INIT_COMPLETE		 (0x1<<31)


#define EMMC_VOLTAGE_WIN		 (0x40FF8080)/* if resp[0] 30bit =1, capacity >2G*/
#define MMC_VOLTAGE_WIN			 (0x1FF<<15)  /*  2.7V-3.6V arg =0x00FF8000 */
#define MMC_LOW_VOLTAGE_WIN		 (0x00FF8080) /*  1.65V -1.95V*/
