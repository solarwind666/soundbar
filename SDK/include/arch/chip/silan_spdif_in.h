...
#ifndef _SILAN_SPDIF_IN_H
#define _SILAN_SPDIF_IN_H
...
#define SPDIF_IN_OVER_FLOW          (1 << 1)    /* frame interrupt */
#define SPDIF_IN_FRAME0             (1 << 2)    /* over flow interrupt */
...
#define SPDIF_IN_OVER_FLOW_MASK     (1 << 1)
#define SPDIF_IN_FRAME0_MASK        (1 << 2)
