#ifndef _CKCORENOMMU_IO_H
#define _CKCORENOMMU_IO_H
 ...
 * differently. On the ckcore architecture, we just read/write the
...
extern void *__ioremap(unsigned long physaddr,
