...
#ifndef __ARCH_CSKY_INCLUDE_CSKYV2_L_IRQ_H
#define __ARCH_CSKY_INCLUDE_CSKYV2_L_IRQ_H
...
#define REG_HI              (68)
#define REG_LO              (69)
#define XCPTCONTEXT_REGS    (70)
#else /* __CSKY_DSP__ */
#define XCPTCONTEXT_REGS    (68)
#endif /* __CSKY_DSP__ */
#else /* CONFIG_CSKY_FPU */
#ifdef  __CSKY_DSP__
#define REG_HI              (34)
#define REG_LO              (35)
...
#define REG_EPSR            REG_PSR
/* The PIC register is usually R10. It can be R9 is stack checking is enabled
 * or if the user changes it with -mpic-register on the GCC command line.
 */

//#define REG_PIC             REG_R28
